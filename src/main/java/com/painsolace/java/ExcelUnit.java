...
public class ExcelUnit {
    ...
    public static void exportExcel(String title, String[] headers, Collection<T> dataset,
    ...
    public static void exportTable2Excel(String title, String[] headers, Collection dataset,
                                         OutputStream out, String pattern) {
        HSSFWorkbook workbook = new HSSFWorkbook();
        ...
        int index = 0;
        Iterator localIterator = dataset.iterator();
